...
def exchangeable_value(budget: float, exchange_rate: float, spread: int, denomination: int) -> int:
    ...
    return budget / (exchange_rate + exchange_fee) // denomination * denomination
...
def non_exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    exchange_fee = exchange_rate * spread / 100
    return int( budget / (exchange_rate + exchange_fee) - exchangeable_value(budget, exchange_rate, spread, denomination))
